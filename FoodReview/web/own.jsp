...
<html>
    <head>
        ...
        <title>JTwin Cities Food Review</title>
    ...
    <body>
        ...
        String mealSelect = request.getParameter("mealSelect");
        ...
        <div class="alignItems">
            ...
            <label>You have selected to review: <%=mealSelect%></label>
            <input type="hidden" name="meal" value="<%=mealSelect%>">
