...
<html>
    ...
    <body>
        ...
        <div class="alignItems">
            ...
            <label>Enter in the Name of a new Food to review!</label>
            <input type="textbox" name="newMeal"><br>
            
            <label>Enter in the Name of the Food's Restaurant!</label>
            <input type="textbox" name="restaurant"><br>
            
            <label>Enter in the Address of the Restaurant!</label>
            <input type="textbox" name="address"><br>
            
            <label>Enter in the Price of the Meal!</label>
            <input type="textbox" name="price"><br>
            
            <label>Enter in the City!</label>
            <input type="textbox" name="city"><br>
            ...
            if (request.getMethod().equalsIgnoreCase("post"))
            {
                ...
                newMeal = request.getParameter("newMeal");
            ...
            <p><%out.println("The meal that you reviewed (" + newMeal + ") shalled be added to our review records!");%></p>
        ...
        if (!newMeal.isEmpty() && !restaurant.isEmpty() && !address.isEmpty() && !city.isEmpty()) 
        {
            stmt.executeUpdate("INSERT INTO Meals (MealName, RestaurantName, RestaurantAddress, Price, City) VALUES ('" + newMeal + "', '" + restaurant + "', '" + address + "', " + price + ", '" + city + "')");
        }

        if (!name.isEmpty() && !newMeal.isEmpty() && !review.isEmpty()) 
        {
            stmt.executeUpdate("INSERT INTO reviews (ReviewID, ReviewName, MealName, ReviewScore, Review) VALUES (" + (reviewSize.size() + 1) + ", '" + name + "', '" + newMeal + "', " + score + ", '" + review + "')");
        }
