...
<html>
    ...
    <body>
        ...
        while (rs.next())
        {
            ...
            meal.setType(rs.getString("restaurantType"));
        ...
        %><section>
            <div class="alignItems">
                ...
                <div class="myboxtwo">
                    <img src="<%=meal.getType()%>.jpg" alt="image of <%=meal.getType()%>" class="innerFood"><%
            }
        }
        ...
        %><section>
            <div class="alignItems">
                ...
                %><div class="myboxthree">
                    <img src="<%=meal.getMealType()%>.jpg" alt="image of <%=meal.getMealType()%>" class="innerFood"><%
